...
genres_aliases_q <- genres$streaminggenre
names(genres_aliases_q) <- genres$question

## for omnivorousness variables
omni_dic <- c(omni_survey_sum_genres_played = "Richness played", 
...
tb <- survey %>%
  ...
  mutate(name = genres_aliases_q[name],
